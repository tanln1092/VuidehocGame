...
public class cl_ButtonLevel4Click : MonoBehaviour {
	...
	void OnClick () {
		...
		switch (name) {
		case "play_button":		
			cl_Level4.Instance4.onPlayButtonFunction ();
			break;
		case "answer_1_button":		
			cl_Level4.Instance4.onAnswerFirstButtonFunction ();
			break;
		case "answer_2_button":		
			cl_Level4.Instance4.onAnswerSecondButtonFunction ();
			break;
		case "next_button":		
		...
		case "infomation_button":	
			cl_Level4.Instance4.onInfomationButtonFunction ();
			break;
		case "close_button":
			Application.Quit();
			break;
