...
public class cl_ButtonLevel3Click : MonoBehaviour {
	...
	void OnClick () {
		...
		switch (name) {
		case "play_button":		
			cl_Level3.Instance3.onPlayButtonFunction ();
			break;
		case "answer_1_button":		
			cl_Level3.Instance3.onAnswerFirstButtonFunction ();
			break;
		case "answer_2_button":		
			cl_Level3.Instance3.onAnswerSecondButtonFunction ();
			break;
		case "next_button":		
		...
		case "infomation_button":	
			cl_Level3.Instance3.onInfomationButtonFunction ();
			break;
